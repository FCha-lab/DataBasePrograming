...
public class Main_Type_Search_RetrofitClient {
    ...
    public Main_Type_Search_RetrofitInterface getApiService(){
        return getInstance().create(Main_Type_Search_RetrofitInterface.class);
    } // api 콜
